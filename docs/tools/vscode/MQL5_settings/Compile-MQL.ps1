...
Param( $FileToCompile = "C:\Users\fan_x\AppData\Roaming\MetaQuotes\Terminal\{{HashCode}}\MQL5\Experts\NcfxyPrograms\NcfxyScripts\InteractionFunctions.mq5")
...
& "C:\Program Files\XM Global MT5\metaeditor64.exe" /compile:"$FileToCompile" /log:"$LogFile" /inc:"C:\Users\Flavio\AppData\Roaming\MetaQuotes\Terminal\{{HashCode}}\MQL5" | Out-Null
