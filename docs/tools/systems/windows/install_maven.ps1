...
$url = 'https://mirrors.tuna.tsinghua.edu.cn/apache/maven/maven-3/3.5.4/binaries/apache-maven-3.5.4-bin.zip'
$downloadFilePath = $ncfxyDownLoadDir + 'apache-maven-3.5.4-bin.zip'
...
$process.WaitForExit()
"Finish installing apache-maven-3.5.4" 
